        ...
        <div className="edublink-header-mini-cart">
            {cartItems.length === 0 && 
                <div className="wrapper empty-cart-wrapper">
                    <h5 className="empty-cart">Votre panier est vide</h5>
                </div>
            }
            {cartItems.length >= 1 && 
                <div className="wrapper">
                    ...
                    <div className="cart-checkout-buttons">
                        <Link href="/cart">
                            <a className="edu-btn btn-small cart-btn">Panier</a>
                        </Link>

                        <Link href="/checkout">
                            <a className="edu-btn btn-small btn-secondary checkout-btn">Paiment</a>
                        </Link>
                    </div>
                </div>
            }
