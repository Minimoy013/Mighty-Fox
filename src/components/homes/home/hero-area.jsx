                ...
                <div className="row align-items-center">
                    <div className="col-lg-6">
                        <div className="banner-content">
                            <h1 className="title" data-sal-delay="100" data-sal="slide-up" data-sal-duration="1000">MI<span className="color-secondary">G</span>HTY FOX <br />Agence Web</h1>
                            <p data-sal-delay="200" data-sal="slide-up" data-sal-duration="1000">Bien plus qu’une agence web, votre allié pour une digitaliser votre entreprise !</p>
                            <div className="banner-btn" data-sal-delay="400" data-sal="slide-up" data-sal-duration="1000">
                                <Link href="/contact-us">
                                    <a className="edu-btn">Contactez-Nous <i className="icon-4"></i></a>
                                </Link>
                            </div>
                    ...
                    <div className="col-lg-6">
                        <div className="banner-thumbnail">
                            <div className="thumbnail" data-sal-delay="500" data-sal="slide-left" data-sal-duration="1000">
                                <img src="/assets/images/banner/laptop-mighty-fox.webp" alt="Laptop Mighty Fox" />
                            </div>
                            <ul className="shape-group">
