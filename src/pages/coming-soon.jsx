            ...
            <section className="coming-soon-page-area ">
                <div className="container">
                    <div className="coming-soon-content">
                        <h1 className="title">Bientôt de retour</h1>
                        <div className="coming-countdown">
                            <div className="countdown-section">
                                <div>
                                    <div className="countdown-number day">{Time('2023-3-31 00:00:00').days}</div>
                                    <div className="countdown-unit">Jours</div>
                                </div>
                            </div>
                            <div className="countdown-section">
                                <div>
                                    <div className="countdown-number hour">{Time('2023-3-31 00:00:00').hours}</div>
                                    <div className="countdown-unit">Jeures</div>
                                </div>
                            </div>
                            <div className="countdown-section">
                                <div>
                                    <div className="countdown-number minute">{Time('2023-3-31 00:00:00').minutes}</div>
                        ...
                        <div className="input-group">
                            <input type="email" className="form-control" placeholder="Pour suivre notre actualité, renseignez votre e-mail" />
                            <button className="edu-btn btn-medium" type="button">Souscrire <i className="icon-4"></i></button>
                        </div>
                    </div>
                </div>
